...
function Section5() {
  ...
  const data = [
    ...
    {
      url: "https://demo18.houzez.co/wp-content/uploads/2020/09/house-model-2-592x444.jpg",
      name: "Superior Villa"
    },
    {
      url: "https://demo18.houzez.co/wp-content/uploads/2020/09/house-model-3-592x444.jpg",
      name: "Large Luxury Villa"
    },
    {
      url: "https://demo18.houzez.co/wp-content/uploads/2020/09/house-model-4-592x444.jpg",
      name: "Standard Modern Villa"
    },
    {
      url: "https://demo18.houzez.co/wp-content/uploads/2020/09/image-9.jpg",
      name: " Superior Villa main"
    },
  ];
      ...
      >
        <Box sx={{ width: "60%", margin: "auto", paddingTop: "50px" }}>
          ...
          >
            Discover our
            <Box
              sx={{ marginLeft: "10px", marginRight: "10px", color: "#16BFBF" }}
            >
              prefab
            </Box>
            solutions
          ...
          >
            ...
            et sem sed sollicitudin. Donec non odio neque.
          </Typography>
        </Box>
